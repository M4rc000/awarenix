  ...
  (_props, ref) => {
    ...
    const submitLandingPage = async (): Promise<LandingPage | null> => {
      ...
      try {
        ...
        setFormData({ name: "", body: "", isSystemTemplate: 0 , redirectTo: "" });
        setErrors({});
      ...
      <div className="space-y-6 p-4 md:p-6 bg-gray-50 dark:bg-gray-900">
        <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm border dark:border-gray-700">
          ...
          <div className={`grid grid-cols-1 gap-3 
            ...
            <div>
              ...
              <Input
                ...
                className={`w-full text-sm sm:text-base h-10 px-3 ${
                  errors.name ? "border-1 border-red-500 dark:border-1 dark:border-red-500" : ""
                }`}
            ...
            <div>
              <LabelWithTooltip required tooltip="The URL to redirect users after form submission">
                Redirect URL
              </LabelWithTooltip>
              <Input
                id="redirect-url"
                ...
                className={`w-full text-sm sm:text-base h-10 px-3 ${
                  errors.redirectTo ? "border-1 border-red-500 dark:border-1 dark:border-red-500" : ""
                }`}
                disabled={isSubmitting}
                required
              />
              {errors.redirectTo && (
                <p className="text-red-500 text-xs mt-1">{errors.redirectTo}</p>
              )}
            </div>
              ...
              <div>
                ...
                <Select
                  ...
                  className={`w-full text-sm sm:text-base h-11 px-3 ${
                    errors.isSystemTemplate ? "border-1 border-red-500 dark:border-1 dark:border-red-500" : ""
                  }`}
                />
