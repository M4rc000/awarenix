...
const (
	...
	AttachmentClicked EventType = "attachment_clicked"
	AttachmentOpened  EventType = "attachment_opened"
)
...
type Event struct {
	...
	Type         EventType      `gorm:"type:enum('opened','clicked','submitted', 'reported', 'attachment_clicked','attachment_opened');not null;index" json:"type"`
